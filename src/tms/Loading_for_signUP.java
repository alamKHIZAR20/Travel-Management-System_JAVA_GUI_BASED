...
//import java.awt.*;
//
//public class Loading_for_signUP extends JFrame implements Runnable{
//
//    Thread t;
...
//
//
//    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/passport.png"));
...
//
//       ImageIcon q1 = new ImageIcon(ClassLoader.getSystemResource("icons/t2.png"));
//    Image q2 = q1.getImage().getScaledInstance(560, 300, Image.SCALE_DEFAULT);
//    ImageIcon q3 = new ImageIcon(q2);
//    JLabel imageq = new JLabel(q3);
//    imageq.setBounds(340, 0, 560, 300);
//
...
//         JLabel l2  = new JLabel("Proceeding you to Sign-Up page :)");
//
//
//
//
